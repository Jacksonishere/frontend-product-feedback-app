...
const FeedbackNotFound = () => {
  return (
    <div className="mt-9 py-8 rounded-lg bg-white">
      <div className="flex flex-col justify-center items-center mx-auto max-w-[350px]">
        <NotFoundGuy />
        <h3 className="mt-7 text-[18px] text-blue-900">Feedback Not Found</h3>
        <p className="mt-4 text-[13px] text-center text-blue-900">
